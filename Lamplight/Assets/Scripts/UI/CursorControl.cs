...
//     version 1.19.0
//     from Assets/Scripts/UI/CursorControl.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/UI/CursorControl.inputactions".
/// </summary>
/// <remarks>
...
public partial class @CursorControl: IInputActionCollection2, IDisposable
{
    ...
    ~@CursorControl()
    {
        UnityEngine.Debug.Assert(!m_Mouse.enabled, "This will cause a leak and performance issues, CursorControl.Mouse.Disable() has not been called.");
    }
